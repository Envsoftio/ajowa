...
begin
  ...
  values
    ('EXP-UTL-001', '11111111-1111-1111-1111-111111111111', 'Diesel Expenses - DG Set', 'EXPENSE', 'Utilities', true, true),
    ('EXP-UTL-002', '11111111-1111-1111-1111-111111111111', 'Electricity Expenses - PSPCL', 'EXPENSE', 'Utilities', true, true),
    ('EXP-UTL-003', '11111111-1111-1111-1111-111111111111', 'Restaurant Electricity Bill', 'EXPENSE', 'Utilities', true, true),
    ('EXP-UTL-004', '11111111-1111-1111-1111-111111111111', 'Vegetable Shop Electricity Bill', 'EXPENSE', 'Utilities', true, true),
    ('EXP-UTL-005', '11111111-1111-1111-1111-111111111111', 'Iron Press Vendor Electricity Bill', 'EXPENSE', 'Utilities', true, true),
    ('EXP-STF-001', '11111111-1111-1111-1111-111111111111', 'Housekeeping Expenses', 'EXPENSE', 'Staff & Services', true, true),
    ('EXP-STF-002', '11111111-1111-1111-1111-111111111111', 'Security Expenses', 'EXPENSE', 'Staff & Services', true, true),
    ('EXP-STF-003', '11111111-1111-1111-1111-111111111111', 'Salary Expenses', 'EXPENSE', 'Staff & Services', true, true),
    ('EXP-STF-004', '11111111-1111-1111-1111-111111111111', 'MyGate Services Expenses', 'EXPENSE', 'Staff & Services', true, true),
    ('EXP-STF-005', '11111111-1111-1111-1111-111111111111', 'Park Plus Expenses', 'EXPENSE', 'Staff & Services', true, true),
    ('EXP-AMC-001', '11111111-1111-1111-1111-111111111111', 'JLPL Bill CAM Water Sewarage', 'EXPENSE', 'Maintenance & AMC', true, true),
    ('EXP-AMC-002', '11111111-1111-1111-1111-111111111111', 'Maintenance Expenses', 'EXPENSE', 'Maintenance & AMC', true, true),
    ('EXP-AMC-003', '11111111-1111-1111-1111-111111111111', 'AMC Schindler Elevators', 'EXPENSE', 'Maintenance & AMC', true, true),
    ('EXP-AMC-004', '11111111-1111-1111-1111-111111111111', 'AMC Kone Elevators', 'EXPENSE', 'Maintenance & AMC', true, true),
    ('EXP-PRO-001', '11111111-1111-1111-1111-111111111111', 'CA Service Charges', 'EXPENSE', 'Professional', true, true),
    ('EXP-PRO-002', '11111111-1111-1111-1111-111111111111', 'Legal Services Expenses', 'EXPENSE', 'Professional', true, true),
    ('EXP-ADM-001', '11111111-1111-1111-1111-111111111111', 'Office Expenses', 'EXPENSE', 'Admin & Office', true, true),
    ('EXP-ADM-002', '11111111-1111-1111-1111-111111111111', 'Bank Charges', 'EXPENSE', 'Admin & Office', true, true),
    ('EXP-ADM-003', '11111111-1111-1111-1111-111111111111', 'Imprest Advance', 'EXPENSE', 'Admin & Office', true, true),
    ('EXP-ADM-004', '11111111-1111-1111-1111-111111111111', 'Imprest Advance FY Closure', 'EXPENSE', 'Admin & Office', true, true),
    ('EXP-ADM-005', '11111111-1111-1111-1111-111111111111', 'Club House Security FFSLLP Refund', 'EXPENSE', 'Admin & Office', true, true),
    ('EXP-EVT-001', '11111111-1111-1111-1111-111111111111', 'Festival Expenses', 'EXPENSE', 'Events', true, true),
    ('INC-MNT-001', '11111111-1111-1111-1111-111111111111', 'CAM Charges', 'INCOME', 'Maintenance', false, true),
    ('INC-MNT-002', '11111111-1111-1111-1111-111111111111', 'DG Set Backup Charges', 'INCOME', 'Maintenance', false, true),
    ('INC-MNT-003', '11111111-1111-1111-1111-111111111111', 'DG Set Automatic Changeover', 'INCOME', 'Maintenance', false, true),
    ('INC-FAC-001', '11111111-1111-1111-1111-111111111111', 'Club House Charges', 'INCOME', 'Facility', false, true),
    ('INC-FAC-002', '11111111-1111-1111-1111-111111111111', 'Restaurant Rent', 'INCOME', 'Facility', false, true),
    ('INC-FAC-003', '11111111-1111-1111-1111-111111111111', 'Vegetable Shop Rent', 'INCOME', 'Facility', false, true),
    ('INC-FAC-004', '11111111-1111-1111-1111-111111111111', 'Parking Commission', 'INCOME', 'Facility', false, true),
    ('INC-FAC-005', '11111111-1111-1111-1111-111111111111', 'RFID Tags', 'INCOME', 'Facility', false, true),
    ('INC-MOV-001', '11111111-1111-1111-1111-111111111111', 'Move In-Out Facilitation Charges', 'INCOME', 'Move & Restoration', false, true),
    ('INC-MOV-002', '11111111-1111-1111-1111-111111111111', 'Restoration Charges', 'INCOME', 'Move & Restoration', false, true),
    ('INC-MSC-001', '11111111-1111-1111-1111-111111111111', 'Scrap', 'INCOME', 'Miscellaneous', false, true),
    ('INC-MSC-002', '11111111-1111-1111-1111-111111111111', 'Festival Contribution', 'INCOME', 'Miscellaneous', false, true),
    ('INC-MSC-003', '11111111-1111-1111-1111-111111111111', 'Penalty Violation Society Guidelines', 'INCOME', 'Miscellaneous', false, true),
    ('INC-MSC-004', '11111111-1111-1111-1111-111111111111', 'Recovery from Builder Shed Inst', 'INCOME', 'Miscellaneous', false, true),
    ('INC-SUS-001', '11111111-1111-1111-1111-111111111111', 'Suspense', 'INCOME', 'Suspense', false, true)
